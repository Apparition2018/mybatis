...
insert into sys_user values(1,  103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'admin', CURRENT_TIMESTAMP(), '', null, '管理员');
insert into sys_user values(2,  105, 'ry',    '若依', '00', 'ry@qq.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'admin', CURRENT_TIMESTAMP(), '', null, '测试员');
