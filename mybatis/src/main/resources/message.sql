...
CREATE TABLE `command_content` (
  `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `CONTENT` varchar(2048) DEFAULT NULL COMMENT '内容',
  `COMMAND_ID` int(11) DEFAULT NULL COMMENT '指令表主键',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
...
INSERT INTO command_content VALUES (2, '精彩段子1' , 1);
INSERT INTO command_content VALUES (3, '精彩段子1' , 1);
INSERT INTO command_content VALUES (4, '精彩段子1' , 1);
INSERT INTO command_content VALUES (5, '精彩段子1' , 1);